...
-------------------------------------------------------------------------------- 
     local RoughSea = Tabs.SeaEvent:AddSection(" Kitsune ")
      ...
      local ToggleEspKitsune = Tabs.SeaEvent:AddToggle("ToggleEspKitsune", {Title = "ESP kisune",Description = "", Default = false })
      ...
      local ToggleTPKitsune = Tabs.SeaEvent:AddToggle("ToggleTPKitsune", {Title = "Tp Kisune",Description = "", Default = false })
      ...
      local ToggleCollectAzure = Tabs.Main:AddToggle("ToggleCollectAzure", {Title = "Aut Azure",Description = "", Default = false })
...
Tabs.Misc:AddButton({
	...
	Callback = function()
		...
		for k, v in pairs(allitem) do
			...
			tvk.CellSize = UDim2.new(0, 70, 0, 70)		tvk.FillDirectionMaxCells = 100
...
if Third_Sea then
local ToggleFindMoon = Tabs.Hop:AddToggle("ToggleFindMoon", {Title = "Find FullMon",Description = "", Default = false })
...
local ToggleMirageIsland = Tabs.Hop:AddToggle("ToggleMirageIsland", {Title = "Find MirageIsland",Description = "", Default = false })
